...
const data = [
  { name: "In Store Orders", value: 40, icon: ShoppingCart },
  { name: "Online Orders", value: 30, icon: Truck },
  { name: " 3PD", value: 40, icon: CheckSquare },
  { name: "Discounts and refunds", value: 10, icon: AlertCircle },
];
