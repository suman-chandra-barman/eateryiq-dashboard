...
export default function CalendarPage() {
  ...
  const { data: eventsData, isLoading, error } = useGetMarketingManagerCalendarEventsQuery({});
  ...
  return (
    <div className="flex flex-col">
      ...
      <CreateEventDialog
        ...
        createCalendarEventMutation={useCreateMarketingManagerCalendarEventMutation()}
      />
